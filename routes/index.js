...
router.get('/', function(req, res, next) {
  res.render('./admin/index', {
    ...
    pengumumanbasket: 'Belum ada pengumuman dari Ekskul Basket',
    pengumumanfutsal: 'Belum ada pengumuman dari Ekskul Futsal',
    pengumumanvolly: 'Belum ada pengumuman dari Ekskul Volly',
    pengumumantnipolri: 'Belum ada pengumuman dari  Ekskul Tni Polri',
  });
});
...
/**tambah informasi eskul
 * INDEX POSTS
 */
router.get('/informasieskul', function (req, res, next) {
  //query
  connection.query('SELECT * FROM info_ekskul ORDER BY id desc', function (err, rows) {
      if (err) {
          req.flash('error', err);
          res.render('/informasieskul', {
              data: ''
          });
      } else {
          //render ke view posts index
          res.render('inforrmasiekskul', {
